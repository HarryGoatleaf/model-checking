...
### Bisimilar states
### AP-deterministic
### Trace equivalence vs Bisimularity

### Bisimulation and CTL

::: {#thm-bisimilarity-ctl}
For a *finitely branching* transition system TS and states $s, s'$ it is **equivalent**:
...
$$s \rightarrow^\alpha u \land s \rightarrow^\alpha v \Rightarrow u=v$$
:::
...
For $TS$ and ample sets $ample: S \rightarrow \mathfrak{P}(Act)$
